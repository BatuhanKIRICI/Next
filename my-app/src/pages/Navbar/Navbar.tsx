...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="flex flex-row justify-center items-center my-5 -mx-3
       bg-white sticky top-0 w-full gap-x-7 "
      >
        <Link href="/">
          <div
            onMouseOver={() => {
      ...
      <div>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae id in
          consectetur impedit dolore, cum ut quis eveniet blanditiis nesciunt
          minus, exercitationem inventore quos. Excepturi dolorum repellat
          veritatis beatae nisi. Lorem ipsum dolor sit amet consectetur,
          adipisicing elit. Quae id in consectetur impedit dolore, cum ut quis
          eveniet blanditiis nesciunt minus, exercitationem inventore quos.
          Excepturi dolorum repellat veritatis beatae nisi.Lorem ipsum dolor sit
          amet consectetur, adipisicing elit. Quae id in consectetur impedit
          dolore, cum ut quis eveniet blanditiis nesciunt minus, exercitationem
          inventore quos. Excepturi dolorum repellat veritatis beatae nisi.Lorem
          ipsum dolor sit amet consectetur, adipisicing elit. Quae id in
          consectetur impedit dolore, cum ut quis eveniet blanditiis nesciunt
          minus, exercitationem inventore quos. Excepturi dolorum repellat
          veritatis beatae nisi.
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae id in
          consectetur impedit dolore, cum ut quis eveniet blanditiis nesciunt
